...
class CapitalOneProvider(BaseProvider):
    name = "Capital One"
    KEYWORDS = ['capital one','capitalone','cap one']
    ...
    def extract(self, pages_text: List[str]) -> Dict[str, Any]:
        out: Dict[str, Any] = {}
        out["issuer"] = {"value": "Capital One", "confidence": 0.95, "evidence": [self.evidence(0, "provider", "Capital One")]}
